$(function () {
    ...
    var option1 = {
        ...
        series: {
            ...
            type: 'bar',
            barWidth: 10,
            data: ['25', '24', '23', '26', '28', '28', '21', '24', '28', '27', '26', '23', '26', '20', '21', '29', '29', '23', '24', '20', '22', '27', '23', '25'],
            itemStyle: {
                normal: {
    ...
    var option1test = {
        ...
        xAxis: {
            ...
            // boundaryGap: false,
            // prettier-ignore
            data: ['00:00', '01:15', '02:30', '03:45', '05:00', '06:15', '07:30', '08:45', '10:00', '11:15', '12:30', '13:45', '15:00', '16:15', '17:30', '18:45', '20:00', '21:15', '22:30'],
            axisLabel: {
                show: true,
                textStyle: {
                    fontSize: '12px',
    ...
    setTimeout(function () {
        ...
        myChart1.setOption(option1test);
